...
public class SignInCell {
    ...
    // 渲染格子
    public void render(MatrixStack matrixStack, FontRenderer font, int mouseX, int mouseY) {
        ...
        if (showText) {
            ...
            font.draw(matrixStack, dayStr, (float) (x + (width - dayWidth) / 2), (float) (y + textureCoordinate.getDateOffset() * this.scale + 0.1f), color);
        }
    }
