...
public class StringInputScreen extends Screen {
    ...
    protected void init() {
        ...
        this.submitButton = AbstractGuiUtils.newButton(this.width / 2 + 5, this.yStart + this.layoutHeight - 28, 95, 20, Component.translatableClient(EI18nType.OPTION, "cancel"), button -> {
            ...
            if (CollectionUtils.isNullOrEmpty(value) || button.getMessage().equals(I18nUtils.getTranslationClient(EI18nType.OPTION, "cancel"))) {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        if (this.inputField.stream().allMatch(in -> StringUtils.isNotNullOrEmpty(in.getValue()))) {
            this.submitButton.setMessage(Component.translatableClient(EI18nType.OPTION, "submit").toString());
        } else {
            this.submitButton.setMessage(Component.translatableClient(EI18nType.OPTION, "cancel").toString());
        }
    }
