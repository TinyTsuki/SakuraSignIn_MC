...
public class Text {
    ...
    public static int getTextComponentColor(ITextComponent textComponent, int defaultColor) {
        return textComponent.getStyle().getColor() == null || textComponent.getStyle().getColor().getColor() == null ? defaultColor : textComponent.getStyle().getColor().getColor();
    }

    public static Text fromTextComponent(ITextComponent component) {
