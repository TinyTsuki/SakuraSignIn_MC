...
public class NotificationManager {
    ...
    public static class Notification {
         ...
         */
        @OnlyIn(Dist.CLIENT)
        private void render(GuiGraphics graphics, Coordinate preInfo, Coordinate screenInfo, long currentTime) {
            ...
            // 实际渲染
            this.doRender(graphics, coordinate);
         ...
         * @param coordinate 当前通知的布局信息
         */
        private void doRender(GuiGraphics graphics, Coordinate coordinate) {
            AbstractGuiUtils.setDepth(graphics, AbstractGuiUtils.EDepth.POPUP_TIPS);
            AbstractGuiUtils.fill(graphics,
            ...
            AbstractGuiUtils.drawLimitedText(
                    cachedText.setGraphics(graphics),
    ...
    public void render(GuiGraphics graphics) {
        ...
        for (Map.Entry<EPosition, Deque<Notification>> entry : notifications.entrySet()) {
            ...
            while (iter.hasNext()) {
                ...
                // 执行渲染
                n.setIndex(i++).render(graphics, preInfo, screenInfo, currentTime);
