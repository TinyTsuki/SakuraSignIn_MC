...
public class SignInCommand {
    ...
    */
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        ...
        Command<CommandSource> helpCommand = context -> {
            ...
            for (int i = 0; (page - 1) * HELP_INFO_NUM_PER_PAGE + i < HELP_MESSAGE.size() && i < HELP_INFO_NUM_PER_PAGE; i++) {
                ...
                commandTips.withStyle(TextFormatting.GRAY);
                helpInfo.append(keyValue.getKey())
                        .append(new StringTextComponent(" -> ").withStyle(TextFormatting.YELLOW))
                        .append(commandTips);
                ...
                .then(Commands.literal("card")
                        .executes(context -> {
                            ...
                            if (!ServerConfig.SIGN_IN_CARD.get()) {
                                player.sendMessage(new TranslationTextComponent(getI18nKey("服务器补签功能被禁用了哦。")));
                            } else {
                                player.sendMessage(new TranslationTextComponent(getI18nKey("当前拥有%d张补签卡"), PlayerSignInDataCapability.getData(player).getSignInCard()));
                            }
                            return 1;
                        })
                        ...
                        .then(Commands.literal("give")
                                ...
                                .then(Commands.argument("num", IntegerArgumentType.integer())
                                        ...
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("给予%d张补签卡"), num));
                                        ...
                                        .then(Commands.argument("player", EntityArgument.players())
                                                .executes(context -> {
                                                    ...
                                                    for (ServerPlayerEntity player : players) {
                                                        IPlayerSignInData signInData = PlayerSignInDataCapability.getData(player);
                                                        signInData.setSignInCard(signInData.getSignInCard() + num);
                                                        player.sendMessage(new TranslationTextComponent(getI18nKey("获得%d张补签卡"), num));
                                                        PlayerSignInDataCapability.syncPlayerData(player);
                                                    }
                                                    return 1;
                                                })
                        ...
                        .then(Commands.literal("set")
                                ...
                                .then(Commands.argument("num", IntegerArgumentType.integer())
                                        ...
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("补签卡被设置为了%d张"), num));
                                            PlayerSignInDataCapability.syncPlayerData(player);
                                            return 1;
                                        })
                                        .then(Commands.argument("player", EntityArgument.players())
                        ...
                        .then(Commands.literal("get")
                                ...
                                .then(Commands.argument("player", EntityArgument.player())
                                        .executes(context -> {
                                            ...
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("玩家[%s]拥有%d张补签卡"), target.getDisplayName().getString(), signInData.getSignInCard()));
                ...
                .then(Commands.literal("config")
                        .then(Commands.literal("get")
                                .then(Commands.literal("autoSignIn")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s自动签到", ServerConfig.AUTO_SIGN_IN.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("timeCoolingMethod")
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("服务器签到时间冷却方式为: %s"), coolingMethod.name()));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("timeCoolingTime")
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("服务器签到冷却刷新时间为: %05.2f"), time));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("timeCoolingInterval")
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("服务器签到冷却刷新间隔为: %05.2f"), time));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("signInCard")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s补签卡", ServerConfig.SIGN_IN_CARD.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("reSignInDays")
                                        .executes(context -> {
                                            ...
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("服务器最大补签天数为: %d"), time));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("signInCardOnlyBaseReward")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s补签仅获得基础奖励", ServerConfig.SIGN_IN_CARD_ONLY_BASE_REWARD.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("date")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("服务器当前时间: %s"), DateUtils.toDateTimeString(DateUtils.getServerDate())));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("playerDataSyncPacketSize")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey("玩家签到数据同步网络包大小为: %d"), ServerConfig.PLAYER_DATA_SYNC_PACKET_SIZE.get()));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("rewardAffectedByLuck")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s奖励领取受幸运影响", ServerConfig.REWARD_AFFECTED_BY_LUCK.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("continuousRewardsRepeatable")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s连续签到奖励持续领取", ServerConfig.CONTINUOUS_REWARDS_REPEATABLE.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                                .then(Commands.literal("cycleRewardsRepeatable")
                                        .executes(context -> {
                                            ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                            player.sendMessage(new TranslationTextComponent(getI18nKey(String.format("服务器已%s循环签到奖励持续领取", ServerConfig.CYCLE_REWARDS_REPEATABLE.get() ? "启用" : "禁用"))));
                                            return 1;
                                        })
                                )
                        )
                                ...
                                .then(Commands.literal("date")
                                        .then(Commands.argument("datetime", StringArgumentType.greedyString())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器时间已设置为: %s"), DateUtils.toDateTimeString(date)));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("autoSignIn")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s自动签到"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("signInCard")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s补签卡"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("reSignInDays")
                                        .then(Commands.argument("days", IntegerArgumentType.integer(1, 365))
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器最大补签天数已被设置为: %d"), days));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("signInCardOnlyBaseReward")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s补签仅获得基础奖励"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("timeCoolingMethod")
                                        .then(Commands.argument("method", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器签到时间冷却方式已被设置为: %s"), method));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("timeCoolingTime")
                                        .then(Commands.argument("time", DoubleArgumentType.doubleArg(-23.59, 23.59))
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器签到冷却刷新时间已被设置为: %05.2f"), time));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("timeCoolingInterval")
                                        .then(Commands.argument("time", DoubleArgumentType.doubleArg(0, 23.59f))
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器签到冷却刷新间隔已被设置为: %05.2f"), time));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("playerDataSyncPacketSize")
                                        .then(Commands.argument("size", IntegerArgumentType.integer(1, 1024))
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("玩家签到数据同步网络包大小已被设置为: %d"), size));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("rewardAffectedByLuck")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s奖励领取受幸运影响"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("continuousRewardsRepeatable")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s连续签到奖励持续领取"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
                                .then(Commands.literal("cycleRewardsRepeatable")
                                        .then(Commands.argument("bool", StringArgumentType.word())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    ServerPlayerEntity player = context.getSource().getPlayerOrException();
                                                    broadcastMessage(player, new TranslationTextComponent(getI18nKey("服务器已%s循环签到奖励持续领取"), bool ? "启用" : "禁用"));
                                                    return 1;
                                                })
                                        )
                                )
    ...
    // 广播消息
    private static void broadcastMessage(ServerPlayerEntity player, ITextComponent message) {
        player.server.getPlayerList().broadcastMessage(new TranslationTextComponent("chat.type.announcement", player.getDisplayName(), message), true);
    }
